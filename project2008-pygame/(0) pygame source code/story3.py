...
const_sound_wry = r'sounds\wry.wav'
const_sound_wry2 = r'sounds\wry2.wav'
...
def main(character_player):
    # Background Music
    play_background_music(const_music_boss)
    ...
    # Introduction
    loading_background()
    if not character_player.seen_intro_3:
        presentation(const_obj_image_presentation_3)

        conversation("Mista: ",
                     'DIO!!!!!!!!!!!!!!',
                     'Let Illene to be free of the power of vampire!')

        conversation('DIO: ',
                     'Huh?, why?',
                     'Everyone will be vampires eventually.')

        conversation('DIO: ',
                     'and they will be my slaves!',
                     'Mista, you are special.',
                     'Thanks me for eating your body, my buddy.',)

        conversation("Mista: ",
                     'DIO!!!!!!!!!!!!!!')

        character_player.seen_intro_3 = True
    ...
    while not var_gameExit:
        ...
        if character_player.is_death():
            play_wav_sound(const_sound_wry)
            conversation('DIO: ',
                         'Wryyyyyyyyyyyyyyyyyyyyyyyyyyyy')
            conversation('DIO: ',
                         "You bustard, it's time for you to say",
                         '"Good bye" to your friends',
                         'and now, me, DIO, will get your body, mista.',
                         'hahahahahahahaha')
        ...
        if is_list_death(enemy_list) and boss_object_1.is_death() and is_list_death(illene_list) and is_list_death(killer_list):
            conversation('Mista: ',
                         'Finally.. Killed DIO!!!!')
            conversation('Mista: ',
                         'The power of vampire was so tough',
                         'But we finally did it..!')
            conversation('Sexy Pistols: ',
                         "Yeeha!! let's check if Illene is going back to human!!")
            conversation('Mista: ',
                         'Love you, sexy pistols',
                         "Let's go back home!")
        ...
        while var_gamewin:
            ...
            good_message('The story mode is over.', 4)
            pygame.display.update()
        ...
        show_one_background(back_x, back_y, const_obj_image_3)
