...
const_background_size_x = 1
const_background_size_y = 8
const_random_list = [] 
...
def main(character_player):
    # Background Music
    play_background_music(const_music_story_2)
    ...
    # Introduction
    loading_background()
    if not character_player.seen_intro_2:
        obj_screen.fill(pygame.Color(0,0,0))

        conversation('Mista: ',
                     "Hey sexy pistols, I can't see anything.",
                     'can you??')

        conversation('Sexy pistols: ',
                     'Not really...',
                     'Anyway, we have to get through this way.')

        presentation(const_obj_image_presentation_2)

        conversation("Illene: ",
                     '!$#!$#!$#!$#!$')

        conversation('Mista: ',
                     "?!!? Illene, where are you?")
        ...
        conversation("Illene: ",
                     "DIO has a lot of killers to save himself.",
                     'Well, he is the king of vampire tho..',
                     'He still cannot resist to the sunlight.',
                     'so he hires them.')

        conversation("Illene: ",
                     "Killers are strong.",
                     'They hide themselves. Be aware of it.')
        character_player.seen_intro_2 = True

    conversation('Mission Object: ',
                    "1. Defeat all the killers")
    ...
    while not var_gameExit:
        ...
        while var_gamewin:
            ...
            good_message('You just finished the mission #2', 4)
            pygame.display.update()
        ...
        show_one_background(back_x, back_y, const_obj_image_2)
